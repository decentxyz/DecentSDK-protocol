    ...
    if (_supports4907) {
      (bool success1, bytes memory data1) = _DCNTSDK.delegatecall(
        abi.encodeWithSignature(
          "deployDCNT4907A((string,string,uint256,uint256,uint256,uint256,uint256),(string,bytes,address))",
          _editionConfig,
          _metadataConfig
        )
      );
      ...
      (bool success2, bytes memory data2) = _DCNTSDK.delegatecall(
        abi.encodeWithSignature(
          "deployDCNT721A((string,string,uint256,uint256,uint256,uint256,uint256),(string,bytes,address))",
          _editionConfig,
          _metadataConfig
        )
      );
